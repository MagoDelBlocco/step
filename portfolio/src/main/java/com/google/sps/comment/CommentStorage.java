...
public class CommentStorage {
  ...
  /** 
   * If the entity id doesn't have a numeric format or is not within (0, IMG_COUNT],
  ...
  /** 
   * If the entity id doesn't have a numeric format or is not within (0, IMG_COUNT], returns null.
   */
